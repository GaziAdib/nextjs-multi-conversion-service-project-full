...
const ImageSizeReducer = () => {
    ...
    return (
        <>
            ...
            <input type="number" placeholder='MaxWidth' name='max width' onChange={(e) => setMaxWidth(e.target.value)} />

            <input type="number" placeholder='MaxHeight' name='max height' onChange={(e) => setMaxHeight(e.target.value)} />
